    ...
    <div className="mt-20">
      <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Sign up for an account</h2> // 수정: 'Sign in'을 'Sign up'으로 변경
        </div>

        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form id="signUpForm" className="space-y-6"> // 수정: 'signInForm'을 'signUpForm'으로 변경
            <div>
            ...
            <div>
              <button type="submit" className="flex w-full justify-center rounded-md bg-blue-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">Sign up</button> // 수정: 'Sign-up'을 'Sign up'으로 변경
            </div>
          </form>
